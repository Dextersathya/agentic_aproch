...
Please build upon Model 1's analysis and provide additional insights or refinements."""
        ...
        workflow.add_conditional_edges("model1", should_continue)
        workflow.add_conditional_edges("model2", should_continue)
...
"""
    ...
    async def process(self, query: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "workflow_completed": final_state["current_step"] == "end"
            }
    ...
    def print_graph_structure(self):
        ...
        print("START")
        print("  ↓")
        print("model1 (LLM Model 1)")
        print("  ↓")
        print("model2 (LLM Model 2)")
        print("  ↓")
        print("END")
        print("=" * 40)
        ...
        # Print node details
        print("\n🔍 Node Details:")
        print("• START: Initialize workflow state")
        print("• model1: Process query with first LLM")
        print("• model2: Refine with second LLM using model1 output")
